...
// Ruta que contienen las texturas. Puedes añadir aquí tus imágenes y reiniciar
// el programa 
...
void MyRender::applyTextureParams() {
  ...
  plane.getMesh(0).getMaterial()->setDiffuseTexture(text[textBound]);
